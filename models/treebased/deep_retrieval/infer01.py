...
def main(args):
    ...
    for epoch_id in range(last_epoch_id + 1, epochs):
        ...
        if record_item_to_user_emb:
            beam_size = dy_model.beam_search_num * 2
            ...
            for key in item_to_user_emb:
                ...
                path,pro = dy_model.generate_candidate_path_for_item(user_emb,beam_size)  # beamSize*4
                list = []
                ...
                if not pernalize_path_to_item_count:
                    ...
                    for i in range(dy_model_class.item_path_volume):
                        # print("dy_model_class.item_path_volume:{}".format(dy_model_class.item_path_volume))
                        # print(len(list))
                        # print("====================")
                        # print(i)
                        # print(list)
